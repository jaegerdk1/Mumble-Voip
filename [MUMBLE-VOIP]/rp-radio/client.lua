...
Radio.Commands = {
    ...
    },
    {
        ...
        Name = "kanal", -- Command name
        Help = "Vælg din radio kanal", -- Command help shown in chatbox when typing the command
        Params = {
            {name = "Nummer", "Enter frequency"}
        },
        Handler = function(src, args, raw)
            if Radio.Has then
                if args[1] then
